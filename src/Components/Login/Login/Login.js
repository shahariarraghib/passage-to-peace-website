...
const Login = () => {
    ...
    const { signInUsingGoogle,
        ...
        handleEmailChange, isLogin, error
    } = useAuth();
                ...
                <div className=' backgrouundStyle2 m-5  d-flex justify-content-center row'>
                    ...
                    <div className='p-5 d-flex align-items-center col-sm-3'>
                        ...
                        <div>
                            ...
                            <Button className='buttonWeight' variant="contained" color="error" onClick={handleGoogleLogin}><span ><GoogleIcon /></span> GOOGLE</Button>
                        </div>
                    </div>
                </div>
            </div>
