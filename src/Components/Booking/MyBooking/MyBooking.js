                                ...
                                < TableBody >
                                    {emailBookings.email ? <>
                                        ...
                                        >
                                            ...
                                            <TableCell align="left">{emailBookings.name}</TableCell>
                                            <TableCell align="left">{emailBookings.email}</TableCell>
                                            <TableCell align="left">{emailBookings.address}</TableCell>
                                            <TableCell align="left">{emailBookings.city}</TableCell>
                                            <TableCell align="left">{emailBookings.phone}</TableCell>
                                            {/* <TableCell align="right">{<img src={allBooking.img} alt="" height={100} width={100} />}</TableCell> */}
                                            ...
                                            <TableCell align="left">
                                                ...
                                                <Stack direction="row" spacing={2}>
                                                    <Button onClick={() => handleDeleteBooking(emailBookings._id)} variant="outlined" color="error" startIcon={<DeleteIcon />}>
                                                        Delete Booking
                                                    </Button>
                                        ...
                                        <h4 className='d-flex justify-content-center p-5'>No Booking result Found</h4>
                                    </>
